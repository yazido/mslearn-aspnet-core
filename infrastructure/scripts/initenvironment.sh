...
# Common Declarations
declare scriptPath=https://raw.githubusercontent.com/yazido/mslearn-aspnet-core/$gitBranch/infrastructure/scripts
...
declare binariesPath=https://raw.githubusercontent.com/yazido/mslearn-aspnet-core/$gitBranch/infrastructure/binaries
declare instanceId=$(($RANDOM * $RANDOM))
declare gitDirectoriesToClone="modules/$moduleName/setup/ modules/$moduleName/src/"
declare gitPathToCloneScript=https://raw.githubusercontent.com/yazido/mslearn-aspnet-core/$gitBranch/infrastructure/scripts/sparsecheckout.sh
if ! [ $rootLocation ]
then
